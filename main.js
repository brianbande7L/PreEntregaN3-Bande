...
class Producto {
  ...
  class BaseDeDatos {
    constructor() {
      ...
      this.agregarRegistro(1, "Dior", 25000, "Perfumes", "dior.png");
      this.agregarRegistro(2, "Boss", 22000, "Perfumes", "boss.png");
      this.agregarRegistro(3, "Calvin Klein", 24000, "Perfumes", "calvin.png");
      this.agregarRegistro(4, "Moschino", 33000, "Perfumes", "moschino.png");
      this.agregarRegistro(4, "VIP", 19000, "Perfumes", "vip.png");
      this.agregarRegistro(4, "Kevin", 10000, "Perfumes", "kevin.png");
      this.agregarRegistro(4, "Kaiak", 33000, "Perfumes", "kaiak.png");
      this.agregarRegistro(4, "Miss Dior", 25000, "Perfumes", "missdior.png");
